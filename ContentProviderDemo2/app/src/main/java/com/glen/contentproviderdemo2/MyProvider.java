...
public class MyProvider extends ContentProvider {
    ...
    public static final String AUTOHORITY = "com.glen.contentproviderdemo2.MyPrivoder";
    ...
    static {
        /**
         * 初始化
         *  若URI资源路径 = content://com.glen.contentproviderdemo2.MyPrivoder/user ，则返回注册码User_Code
         *  若URI资源路径 = content://com.glen.contentproviderdemo2.MyPrivoder/job ，则返回注册码Job_Code
         */
