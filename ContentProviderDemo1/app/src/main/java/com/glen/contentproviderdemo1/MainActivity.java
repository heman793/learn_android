...
public class MainActivity extends AppCompatActivity {
    ...
    {
        //设置URI
        Uri uri_user = Uri.parse("content://com.glen.contentproviderdemo1.MyPrivoder/user");
    ...
    {
        Uri uri_job = Uri.parse("content://com.glen.contentproviderdemo1.MyPrivoder/job");
